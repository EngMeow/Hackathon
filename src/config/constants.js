import figmaIpsum from "../assets/image/Figma ipsum.png";
import interviewIpsum from "../assets/image/InterviewMe.png";
import loremIpsum from "../assets/image/Lorem ipsum.png";
import officeIpsum from "../assets/image/Office ipsum.png";
import pizzaIpsum from "../assets/image/Pizza Ipsum.png";
import potterIpsum from "../assets/image/Potter ipsum.png";
import logo from "../assets/image/AI Planet Logo.svg";
import waves from "../assets/image/waves.svg";
import idea from "../assets/image/Hand holding bulb 3D.png";
...
export const initialData = [
  {
    ...
    hackathonStartDate: "2024-03-20",
    hackathonEndDate: "2024-03-22",
    githubRepositoryLink: "https://github.com/user/GenAI",
    otherLinks: "https://devpost.com/GenAI",
    createdAt: "2024-03-20T04:30:00Z",
  },

  {
    ...
    description:
      "Introducing the incredible Deep Learning, the ultimate mobile solution for managing tasks and activities with unparalleled ease and efficiency. This feature-rich app boasts a user-friendly interface that ensures a seamless user experience. With Deep Learning, you can effortlessly create, prioritize, and track tasks, all from the palm of your hand.\n\nSetting due dates, receiving timely reminders, and collaborating with your team have never been easier. Whether you're a busy professional managing complex projects or a dedicated student organizing assignments, Deep Learning is tailored to meet your unique needs. Say goodbye to the chaos of task management and welcome a new era of productivity with Deep Learning.\n\nJoin the millions of satisfied users who have experienced the transformative power of our app. Discover how Deep Learning can help you regain control of your tasks and supercharge your daily productivity.",
    coverImage: interviewIpsum,
    hackathonName: "App Challenge 2024",
    hackathonStartDate: "2024-03-01",
    hackathonEndDate: "2024-03-03",
  ...
  },
  {
    ...
    description:
      "The Data Management system is a comprehensive business intelligence and data analytics solution designed to empower organizations with actionable insights. Our platform offers advanced data visualization, predictive analytics, and machine learning capabilities, making it the ideal choice for businesses seeking data-driven decision-making.\n\nWith the ability to connect to various data sources, including databases, cloud services, and APIs, our platform enables users to seamlessly analyze and visualize their data. From financial forecasting to customer segmentation, the possibilities are limitless.\n\nJoin us in unlocking the potential of your data. Experience the power of informed decision-making and competitive advantage with the Data Management system.",
    coverImage: officeIpsum,
    hackathonName: "Data Innovation Challenge",
    hackathonStartDate: "2024-03-10",
    hackathonEndDate: "2024-03-12",
  ...
  },
  {
    ...
    description:
      "Revolutionize your customer support with our AI-Powered Chatbot solution. This advanced chatbot is designed to handle customer inquiries, provide instant assistance, and streamline your support processes. Powered by state-of-the-art natural language processing (NLP) and machine learning algorithms, our chatbot can understand and respond to customer queries with human-like intelligence.\n\nWith seamless integration into your website or application, our chatbot is available 24/7, ensuring that your customers receive prompt and accurate support. From answering frequently asked questions to resolving complex issues, our chatbot can do it all. Improve customer satisfaction, reduce response times, and scale your support operations effortlessly with our AI-Powered Chatbot.\n\nJoin the future of customer support and discover how AI can transform your business.",
    coverImage: potterIpsum,
    hackathonName: "AI Innovation Challenge",
    hackathonStartDate: "2024-03-15",
    hackathonEndDate: "2024-03-17",
